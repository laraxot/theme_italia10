...
=======
    ...
    {{--<div id="sidebar" class="sidebar collapsed">
        ...
        <div class="sidebar-tabs">
            <ul role="tablist">
                <li>
                    <a href="#home" role="tab" alt="info"
                        title="Was ist das hier und wie pflege ich die Daten?">&#9776;</a>
                </li>
            </ul>
            ...
            <ul role="tablist">
                ...
                <li>
                    <a href="https://github.com/CodeforKarlsruhe/direktvermarkter" role="tab" target="_blank"
                        rel="noopener">
                        <img width="20px" style="padding-top: 8px;" margin-top="5px" src="img/github.svg"
                            alt="Github" title="Repository auf Github.com">
                    </a>
                </li>
                <li>
        ...
        <div class="sidebar-content">
            <div class="sidebar-pane" id="home">
                ...
                <a href="https://github.com/CodeforKarlsruhe/direktvermarkter/blob/master/update_data.js"
                    target="_blank" rel="noopener">einem Script</a> manuell in regelmäßigen Abständen&#8482;
